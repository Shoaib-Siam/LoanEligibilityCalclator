...
<div class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="w-full max-w-xl bg-white p-8 rounded-lg shadow-md">
        <!-- Page Title -->
        <h1 class="text-2xl font-bold text-center text-gray-800 mb-6">Calculate EMI</h1>
        ...
        <div class="mt-8 flex justify-between gap-4">
            ...
            <a href="{{ route('loan.eligibility') }}" class="w-1/2 text-center bg-gray-500 text-white py-2 rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 transition duration-300">
